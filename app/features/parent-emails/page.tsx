    ...
    <>
      ...
      <nav>
        <div className="nav-inner">
          ...
          <TrackedLink href="https://getshorthand.app" className="btn-primary" label="nav_try_free_parent-emails">Try Free</TrackedLink>
        </div>
      </nav>
      ...
      <div className="detail-cta-section">
        ...
        <TrackedLink href="https://getshorthand.app" className="btn-primary" label="cta_get_started_parent-emails">Get Started Free →</TrackedLink>
      </div>
